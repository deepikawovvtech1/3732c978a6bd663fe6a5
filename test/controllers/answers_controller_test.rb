...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { answerA: @answer.answerA, answerB: @answer.answerB } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { answerA: @answer.answerA, answerB: @answer.answerB } }
